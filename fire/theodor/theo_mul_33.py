    ...
    for j in range(1, n_time):
        ...
        for k in range(1, micro_t+1):
            ...
            if libtheofast is not None:
                ...
                libtheofast.heat_potential_time_step(ctypes.c_int(aux),ctypes.c_int(auy),ctypes.c_float(factor), h_pot.ctypes.data, ctypes.c_float(cc), ctypes.c_int(plusac), ctypes.c_float(tratio), ctypes.c_float(ad), ctypes.c_float(bd), del_pot.ctypes.data)
