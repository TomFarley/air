...
surface_normal_rTz=cylindrical_transform_surface_normal_xyz(surface_normal_xyz,cylindrical_unit_vectors) #will give the wrong z polarity for z>0.
dir_surface_normal_rTz=ensure_outwards_normal(surface_normal_rTz,cylindrical_unit_vectors,point1,loc,tile) #gives correct direction for any probe z polarity.
