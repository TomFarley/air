...
class TestSchedulerWorkflowMast(unittest.TestCase):
...
def suite():
    ...
    suite.addTest(TestSchedulerWorkflowMast.test_scheduler_workflow_mast_rir)
    suite.addTest(TestSchedulerWorkflowMast.test_scheduler_workflow_mast_rit)
    return suite
