...
class TestInterfaces(unittest.TestCase):
    ...
    def test_id_strings(self):
        values = {'machine': 'MAST', 'camera': 'rit', 'pulse': 23586, 'lens': '25mm', 't_int': 2.7e-5,
                  'frame_no': 1234, 'frame_time': 0.5123}

        id_strings = {}
        kwargs = {key: values[key] for key in ['pulse', 'camera', 'machine']}
        id_strings = generate_pulse_id_strings(id_strings, **kwargs)
        expected = {'pulse_id': 'MAST-23586', 'camera_id': 'MAST-23586-rit'}
